...
package com.reactnativeespressif.Provisionning.security;

import android.util.Log;

import com.reactnativeespressif.Provisionning.utils.HexEncoder;
...
public class Security1 implements Security {
    ...
    private void processStep0Response(byte[] hexData) throws RuntimeException {
        try {
            ...
            String debug = new String(hexData, UTF_8);
            Log.d(TAG, String.format("DEBUG HEXDATA: %s", debug));
