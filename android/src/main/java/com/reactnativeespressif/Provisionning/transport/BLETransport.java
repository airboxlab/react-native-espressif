...
package com.reactnativeespressif.Provisionning.transport;
...
import com.reactnativeespressif.Provisionning.DeviceConnectionEvent;
...
public class BLETransport implements Transport {
    ...
    public void sendConfigData(String path, byte[] data, ResponseListener listener) {
        ...
        if (uuidMap.containsKey(path)) {
            ...
            if (characteristic == null) {
                characteristic = service.getCharacteristic(UUID.fromString(this.bleConfigUuid));
            }
     ...
     */
    public void connect(BluetoothDevice bluetoothDevice, UUID primaryServiceUuid, Promise promise) {
    ...
    private Promise connectionPromise = null;
